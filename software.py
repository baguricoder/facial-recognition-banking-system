...
class BankUi:
    ...
    def enroll_user(self):
        ...
        self.pentry = Entry(self.frame,bg="honeydew",show="*",highlightcolor="#50A8B0",
           highlightthickness=2,
            highlightbackground="white") 
        self.plabel = Label(self.frame, text="confirm password",bg="#0019fc",fg="white",font=ARIAL)
        self.plabel = Label(self.frame, text="confirm password",bg="#0019fc",fg="white",font=ARIAL)
        self.pentry = Entry(self.frame,bg="honeydew",show="*",highlightcolor="#50A8B0",
           highlightthickness=2,
            highlightbackground="white") 
        self.cplabel=Label(self.frame,text="confirm password",bg="#0091fc",fg="white",font="Arial")
    ...
    def enroll_and_move_to_next_screen(self):
        ...
        cpassword=self.centry.get()
        if password!=cpassword:
            messagebox._show("password not match")
            self.enroll_user()
